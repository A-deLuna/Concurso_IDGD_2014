...
function player.screenBound()
	if (not enemy.stopGenerate) then 	
		...
		if (player.x < 0 and (player.y < map.doorHeight1 or player.y > map.doorHeight2)) then 
			player.x = 0
		elseif (player.x + player.width > screenWidth and (player.y < map.doorHeight1 or player.y > map.doorHeight2)) then
			player.x  = screenWidth - player.width
		elseif (player.y <0 and (player.x  < map.doorWidth1 or player.x > map.doorWidth2)) then
			player.y = 0
		elseif( player.y + player.height > screenHeight and (player.x  < map.doorWidth1 or player.x > map.doorWidth2)) then
			player.y = screenHeight - player.height
		end
	end 
end
